    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-file" style = "color : #2F4F4F"></i> Dekripsi AES-128</h1>
          </div>
          <div>
            <ul class="breadcrumb">
                  ...
                  <table class="table striped">
                       ...
                       <tr>
                         ...
                         <td>
                           ...
                           <input type="submit" name="decrypt_now" value="Dekripsi File" class="form-control btn btn-primary" style = "background-color : #2196F3">
                         </div>
                       </td>
                       </tr>
                  </table>
