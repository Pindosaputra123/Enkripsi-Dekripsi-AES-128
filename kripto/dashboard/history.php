...
?>
  <head>
    <title><?php echo $data['fullname']; ?> - Daftar Riwayat</title>
    <meta charset="utf-8">
    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar hidden-print">
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" >
            ...
            <li><a href="history.php"  style="border-color:#fff;background-color: #778899;"><i class="fa fa-list-alt"></i><span>Daftar Riwayat</span></a></li>
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1 style = "color : #2F4F4F"><i class="fa fa-list-alt" style = "color : #2F4F4F"></i> Riwayat Enkripsi dan Dekripsi</h1>
          </div>
          <div>
            <ul class="breadcrumb">
              <li><i class="fa fa-home fa-lg"></i></li>
              <li><a href="index.php" style = "color : #2196F3">Dashboard</a></li>
              <li>Daftar Riwayat Enkripsi dan Dekripsi</li>
            </ul>
          </div>
        </div>
        <div class="row">
                  ...
                  <table id="file" class="table striped">
                    <thead>
                        <tr>
                          ...
                          <td><strong>Waktu Enkripsi</strong></td>
                          <td><strong>Waktu Dekripsi</strong></td>
                        ...
                        <?php
                          ...
                          <tr>
                            ...
                            <td><?php echo $data['waktu']; ?> Detik</td>
                            <td><?php if ($data['status'] == 1) {
                              echo "Belum didekripsi";
