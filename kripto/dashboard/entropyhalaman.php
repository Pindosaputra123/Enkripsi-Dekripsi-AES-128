...
?>
  <head>
    <title><?php echo $data['fullname']; ?> - Tes Entropy</title>
    <meta charset="utf-8">
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1 style = "color : #2F4F4F"><i class="fa fa-hourglass-half" style = "color : #2F4F4F"></i> Form Tes Entropy</h1>
          </div>
          <div>
            <ul class="breadcrumb">
              <li><i class="fa fa-home fa-lg"></i></li>
              <li><a href="index.php" style = "color : #2196F3">Dashboard</a></li>
              <li>Form Tes Entropy</li>
            </ul>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-body">
                ...
                ?>
                <h3 align="center">Tes Entropy <i style="color:blue"><?php echo $data2['file_name_finish'] ?></i></h3><br>
                <form class="form-horizontal" method="post" action="entropy-process.php?id_file">
                <div class="table-responsive">
                  <table class="table striped">
                      ...
                      <input type="submit" name="tes_entropy" value="Tes Entropy Sekarang" class="btn btn-primary" style = "background-color : #2196F3">
                      </td>
                      </tr>
                      <tr>
                         <td><h3>Tes Entropy</h3></td>
                         <td><h3>:</h3></td>
                         <td><h3><?php echo $data2['tes_en']; ?> %</h3></td>
                       </tr>
                  </table>
                </div>
              </form>
