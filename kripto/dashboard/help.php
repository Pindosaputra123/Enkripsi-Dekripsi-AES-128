...
?>
  <head>
    <title><?php echo $data['fullname']; ?> - Bantuan</title>
    <meta charset="utf-8">
    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar hidden-print">
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" >
            ...
            <li><a href="help.php"  style="border-color:#fff;background-color: #778899;"><i class="fa fa-question-circle"></i><span>Bantuan</span></a></li>
          </ul>
        </section>
      </aside>
      <!--  -->
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1 style = "color : #2F4F4F"><i class="fa fa-question-circle" style = "color : #2F4F4F"></i>Bantuan</h1>
          </div>
          <div>
            <ul class="breadcrumb">
              <li><i class="fa fa-question-circle fa-lg"></i></li>
              <li><a href="#" style = "color : #2196F3">Bantuan</a></li>
            </ul>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-body">
                ...
                <li>Menu Dashboard berisikan penggunaan Aplikasi ini.</li>
                ...
                <li>Menu Tes Avalanche Effect adalah menu untuk uji Avalanche Effect</li>
				<li>Menu Tes Entropy adalah menu untuk uji Entropy</li>
				<li>Menu Daftar Riwayat berisikan menu untuk melihat dafar riwayat file yang telah dienkripsi dan didekripsi</li>
                <li>Menu Tentang merupakan latar belakang dari aplikasi.</li>
                <li>Menu Bantuan merupakan menu untuk membantu pengguna dalam penggunaan aplikasi.</li>
              </div>
            </div>
          </div>
        </div>
