    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1 style = "color : #2F4F4F"><i class="fa fa-gears" style = "color : #2F4F4F"></i> Tes Avalanche Effect</h1>
          </div>
          <div>
            <ul class="breadcrumb">
              <li><i class="fa fa-home fa-lg"></i></li>
              <li><a href="index.php" style = "color : #2196F3">Dashboard</a></li>
              <li>Tes Avalanche Effect</li>
            </ul>
          </div>
        </div>
        <div class="row">
                  ...
                  <thead>
                        ...
                        <?php
                          ...
                          <tr>
                            ...
                            echo '<a href="tes_ava.php?id_file='.$a.'" class="btn btn-info">Tes Avalanche Effect</a>'; ?></td>
                          </tr>
                          <?php
                          $i++;
                        } ?>
